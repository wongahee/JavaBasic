...
public class Employees {
    ...
    private int salary;
    private double commission_pct;      // 수수료
    private int manager_id;
    private int department_id;      // 부서명
    ...
    public Employees(int employee_id, String first_name, String last_name, String email,
                     ...
                     double commission_pct, int manager_id, int department_id) {
    ...
    public void setCommission_pct(double commission) {
        this.commission_pct = commission;
    }

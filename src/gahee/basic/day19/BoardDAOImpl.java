...
import gahee.basic.jdbc.JDBCUtil;
...
public class BoardDAOImpl implements BoardDAO {
    ...
    private String insertSQL = " insert into board (title, userid,contents) " +
                               " values (?, ?, ?) ";
    private String selectSQL = " select bdno, title, userid, mid(regdate, 1, 10), views, thumbup  " +
    ...
    private String thumbSQL = " update board set thumbup = thumbup + 1 " +
                              " where bdno = ? ";
    private String updateSQL = " update board set title = ?, contents = ?, " +
    ...
    public BoardVO selectOneBoard(int bdno) {
        ...
        try ( Connection conn = jdbc.openConn();
            ...
            try ( PreparedStatement pstmt2 = conn.prepareStatement(selectOneSQL);
                ...
                ResultSet rs = pstmt2.executeQuery();  // 본문 조회

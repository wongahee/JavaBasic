...
public class SungJukV4DAOImpl implements SungJukV4DAO {
    ...
    // sungjuk 테이블에서 '번호,이름,국어,영어,수학,등록일' 등을 조회한 후
    // ArrayList에 담아 Service로 넘김
    @Override
    ...
    public SungJukVO selectOneSungJuk(int sjno) {
        ...
        try ( Connection conn = jdbc.openConn();
            ...
            ResultSet rs = pstmt.executeQuery();  // 자동으로 닫기
                while (rs.next()){ // 위 4개 생성자, 밑 5개
